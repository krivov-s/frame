namespace PptxTemplater
{
    ...
    public sealed class Pptx : IDisposable
    {
        ...
        /// </summary>
        public static readonly Regex TagPattern = new(@"{{[A-Za-z0-9_+\-\.]*}}");
        ...
        public int SlidesCount()
        {
            ...
            return (presentationPart != null) ? presentationPart.SlideParts.Count() : 0;
        }
        ...
        public byte[] GetThumbnail(Size size = default)
        {
            byte[] thumbnail = [];
            // =================================================================================================
            // =============== ЭТО Я ЗАКОММЕНТИЛ: НЕ СТАЛ РАЗБИРАТЬСЯ ОТКУДА ВЗЯТЬ ТИП Image ===================
            // =================================================================================================
        ...
        public PptxSlide? GetSlide(int slideIndex)
        {
            ...
            if (presentationPart != null && presentationPart.Presentation.SlideIdList != null)
            {
                ...
                SlideId slideId = (SlideId)slideIds[slideIndex];
        ...
        {
            return ReplaceTable_Multiple(slideTemplate, tableTemplate, rows, []);
        }
